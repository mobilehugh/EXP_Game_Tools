...
latinicize = {
    ...
    "Camel": ["Camelidae", "Artiodactyla", "Humpalia"],
    "Capybara": ["Hydrochoeridae", "Cuteus", "Snoutis"],
    "Cat": ["Felidae", "Purrifia", "Clawilius"],
    "Caterpillar": ["Lepidoptera", "Larvae", "Insecta"],
    "Centipede": ["Chilopoda", "Arthropoda", "Myriapoda"],
    "Chimpanzee": ["Fecflingius", "Banarius", "Uhoohia"],
    "Cicada": ["Cicadidae", "Hemiptera", "Insecta"],
    "Clam": ["Bivalvia", "Mollusca", "Invertebrata"],
    "Cockroach": ["Blattodea", "Insecta", "Blattidae"],
    "Conifer": ["Pinophyta", "Pinales", "Plantae"],
    ...
    "Dragon": ["Draco", "Mythica", "Imaginata"],
    "Dragonfly": ["Odonata", "Anisoptera", "Insecta"],
    "Duck": ["Anatidae", "Anseriformes", "Aves"],
    "Elephant": ["Elephantidae", "Proboscidea", "Forgetnotius"],
    "Fern": ["Polypodiopsida", "Polypodiales", "Plantae"],
    "Ferret": ["Mustelidae", "Carnivora", "Ferritis"],
    "Fly": ["Diptera", "Brachycera", "Insecta"],
    "Frog": ["Anura", "Amphibia", "Vertebrata"],
    "Gila Monster": ["Helodermatidae", "Squamata", "Gilia"],
    "Giraffe": ["Giraffidae", "Artiodactyla", "Neckius"],
    "Goat": ["Bovidae", "Artiodactyla", "Bleetalia"],
    "Goose": ["Anatidae", "Anseriformes", "Aves"],
    "Gorilla":["Silveria", "Primatis", "Bananimus"],
    "Grasshopper": ["Acrididae", "Orthoptera", "Insecta"],
    "Guinea pig": ["Caviidae", "Guinius", "Expendabilis"],
    "Hammerhead": ["Sphyrnidae", "Carcharhiniformes", "Chondrichthyes"],
    "Hawk": ["Accipitridae", "Accipitriformes", "Aves"],
    "Hectapus": ["Octopedidae", "Cephalopoda", "Mollusca"],
    "Hippopotamus": ["Hippopotamidae", "Artiodactyla", "Flatuatus"],
    "Horse": ["Equidae", "Perissodactyla", "Neighmonius"],
    "Horseshoe Crab": ["Limulidae", "Xiphosura", "Arthropoda"],
    "Jellyfish": ["Scyphozoa", "Cnidaria", "Invertebrata"],
    "Kangaroo": ["Macropodidae", "Diprotodontia", "Hoppiticus"],
    "Kelp": ["Laminariaceae", "Laminariales", "Plantae"],
    "Koala": ["Phascolarctidae", "Diprotodontia", "Chlamidius"],
